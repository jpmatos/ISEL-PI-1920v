...
const inviteApi = require('./web-api/invite-web-api')
...
const inviteDB = require('./data/cota-db').init(process.env.ES_BASE_URL, process.env.ES_INVITE_INDEX, nodefetch)
...
const inviteServices = require('./service/invite-services').init(cotaDB, authDB, inviteDB, boom)
const cotaController = require('./web-api/controller/cota-controller').init(cotaServices)
const groupController = require('./web-api/controller/group-controller').init(cotaServices, boom)
const authController = require('./web-api/controller/auth-controller').init(authServices, boom)
const inviteController = require('./web-api/controller/invite-controller').init(inviteServices, boom)
...
app.use('/invite', inviteApi(express.Router(), inviteController, requiresAuth))
