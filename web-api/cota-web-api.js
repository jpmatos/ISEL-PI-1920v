...
module.exports = (router, cotaController, groupController) => {
    ...
    router.put('/groups/:groupID/series/:serieID', (req, res) => groupController.addSerie(req, res))
    router.delete('/groups/:groupID/series/:serieID', (req, res) => groupController.removeSerie(req, res))
